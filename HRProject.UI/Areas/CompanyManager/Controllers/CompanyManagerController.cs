...
//        {
//            List<CompanyManager> companyManagers = new List<CompanyManager>();
...
//                    companyManagers = JsonConvert.DeserializeObject<List<CompanyManager>>(apiCevap);
//                }
//            }
//            var newLoginClaim = new Claim("PhotoUrl", companyManagers[0].PhotoURL);

//            var currentCompanyManager = HttpContext.companyManager.Identity as ClaimsIdentity;
